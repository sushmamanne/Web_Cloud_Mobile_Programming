...
var Hangman = (function () {
    ...
    Hangman.prototype.guess = function (guess) {
        ...
        Hangman.prototype.hint = function() {
            if (this.WORD == "BANANA") {
                document.getElementById("hintimage").innerHTML = "<img src = 'bananas.jpg' />"
            }else if (this.WORD == "WATERMELON"){
                document.getElementById("hintimage").innerHTML = "<img src = 'water.jpeg' />"
            }
