...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void register(View view) {
        ...
        {
            lblPasswordError.setText("Please enter confirm password");
        }
        else if (!password.matches(confpassword)){
            lblPasswordError.setText("Password and confirm password are not equal");
        }
